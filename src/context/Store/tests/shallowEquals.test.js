...
describe('shallowEquals', () => {
  ...
  it('should return true when two objects are the same length but have different orders in their keys', () => {
    const a = { key1: 1, key2: 2, key3: 3 };
    const b = { key3: 3, key1: 1, key2: 2 };
    const result = shallowEquals(a, b);
