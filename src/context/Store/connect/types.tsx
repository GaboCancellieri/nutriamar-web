...
export type MapStateToPropsCallback<S, P> = (state: S, ownProps: P) => (Partial<S> | P) | (Partial<S> & P);
...
export interface ConnectOptions {
  ...
  mapDispatchToProps?: MapDispatchToPropsArrayItem<any>[] | MapDispatchToPropsObject<any>;
  pure?: boolean;
  forwardRef?: boolean;
...
export type ConnectType = (options: ConnectOptions) => (Component: ComponentType<any>) => (ownProps: any) => any;
